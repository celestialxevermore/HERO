...
class Model(nn.Module):
    ...
    def __init__(self, configs, patch_len=16, stride=8):
        ...
        #/mnt/storage/personal/eungyeop/TIMELLM/alps/modelhub/pretrained_model/LLaMA/7B_hf
        #'/mnt/storage/personal/eungyeop/TIMELLM/alps/modelhub/pretrained_model/LLaMA/7B_hf/'
        #self.llama_config = LlamaConfig.from_pretrained('/mnt/storage/personal/eungyeop/TIMELLM/alps/modelhub/pretrained_model/LLaMA/7B_hf/')
